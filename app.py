...
st.markdown('<p class="centered-title-block" style="color: #4CAF50; font-weight: bold; font-size: 14px; margin-bottom: 25px;">🚀 Created by Srinivasta</p>', unsafe_allow_html=True)
...
# Add Text Content to the Document Structure
